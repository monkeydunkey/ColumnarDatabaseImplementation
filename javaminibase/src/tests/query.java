...
//            }
            ...
            outFilter[1].operand1.symbol = new FldSpec (new RelSpec(RelSpec.innerRel),
        ...
        else if( accessType == "BTREE" || accessType == "BITMAP")
        {
            ...
            if (btScanNOTbmScan){
                ...
                cfName.createBTreeIndex(cFile.getColumnIndexByName(valConst_ColName));

                String indexName = cfName + String.valueOf(cfName.getColumnIndexByName(valConst_ColName)) + ".Btree";

                ValueClass colValCls = cfName.getColumnTypeByName(valConst_ColName);
                ...
                ciScanObj = new ColumnIndexScan(new IndexType(1), cfName, indexName,
                        colAttrType, sizes, outFilter, false);
            } else {
...
//            if( i == 0 ) // COLUMNDBNAME
//            {
//                dbName = argsList.get(i);
//            }
//            else if( i == 1 ) // COLUMNARFILENAME
//            {
//                cfName = argsList.get(i);
//            }
//            //else if( args[i].charAt(0) == '[' ) // Start of TAGETCOLUMNNAMES list
//            else if( argsList.get(i).startsWith("[") )
//            {
//                str = argsList.get(i).substring(1);
//
//                if( argsList.get(i).endsWith("]") )//args[i].charAt( args[i].length() - 1 ) == ']' ) // Covers case of only one element in TAGETCOLUMNNAMES list
//                {
//                    str = str.substring( 0, str.length() - 1 );
//                    targetColNames.add(str);
//                    colNamesDone = true;
...
//                }
//            }
//            else if( argsList.get(i).endsWith("]") )//args[i].charAt( args[i].length() - 1 ) == ']' ) // Last element in TARGETCOLUMNNAMES list
//            {
//                str = args[i].substring( 0, args[i].length() - 1 );
//                targetColNames.add(str);
//                colNamesDone = true;
...
//            else if( i == newIndex ) // VALUECONSTRAINT -> COLUMNNAME
//            {
//                valConst_ColName = argsList.get(i).substring(1); // Removes { from COLUMNNAME
//            }
//            else if( i == newIndex + 1 ) // VALUECONSTRAINT -> OPERATOR
//            {
//                valConst_Operator = argsList.get(i);
//            }
//            else if( i == newIndex + 2 ) // VALUECONSTRAINT -> VALUE
//            {
//                //valConst_Value = Integer.parseInt(args[i].substring( 0, args[i].length() - 1 )); // Removes } from VALUE
//                valConst_Value = argsList.get(i).substring( 0, argsList.get(i).length() - 1 ); // Removes } from VALUE
//            }
//            else if( i == newIndex + 3 ) // NUMBUF
//            {
//                numBuf = Integer.parseInt(argsList.get(i));
//            }
//            else // ACCESSTYPE
//            {
//                accessType = argsList.get(i);
//            }
//        }
//
//        /* Uncomment for debugging */
...
//            outFilter[1].next  = null;
//            outFilter[1].type1 = new AttrType(AttrType.attrSymbol);
//            outFilter[1].operand1.symbol = new FldSpec(new RelSpec(RelSpec.innerRel), cFile.getColumnIndexByName(valConst_ColName));
//
//            if( isInt )
//            {
//                outFilter[1].type2 = new AttrType(AttrType.attrInteger);
...
//            trgtColNamesArr = targetColNames.toArray(trgtColNamesArr);
//            for (int i = 0 ; i < trgtColNamesArr.length; i++) {
//                projection[i] = new FldSpec(new RelSpec(RelSpec.outer), cFile.getColumnIndexByName(trgtColNamesArr[i]));
//            }
//
//            try {
//                if(fScanNOTcScan) {
